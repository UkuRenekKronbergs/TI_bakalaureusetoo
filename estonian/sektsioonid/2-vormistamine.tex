...
Joonisteks nimetame kõiksuguseid lõputöösse lisatud pilte, olgu nendeks graafikud, fotod või ekraanitõmmised. Need kõik tuleb nimetada joonisteks, lisada number ja pealdis. Siin LaTeX-i mallis käib see nii, et tuleb pilt kopeerida või laadida üles \verb|joonised| kausta (vt joonis~\ref{fig:kaustad}). Seejärel saab pilti kasutada järgneva koodiga:
