...
\begin{table}[htb!]
    ...
    Backend & Python 3.12 + FastAPI & Anthropic SDK on Pythonis küps; FastAPI annab automaatselt OpenAPI dokumentatsiooni ja valideerimisrakendused. \\
    ...
    Skeemi\-valideerimine & Pydantic + JSON Schema & Backendis valideerib mudeli vastust enne kasutajale saatmist; vea korral palutakse mudelilt parandus. \\
...
\end{minted}
\caption{LLM-i kutsumise lihtsustatud Pythoni-kood koos JSON-prefilliga. Tegelikus prototüübis lisanduvad logimise, kordusküsimise (\emph{ingl. retry}) ja vea käsitlemise abstraktsioonid ning eraldi pakkujakihid Anthropici ja OpenAI jaoks.}
\label{fig:kood-llm}
\end{figure}
