...
Struktureeritud prompt on oluliselt mahukam ja erineb üldisest promptist neljal olulisel viisil: (1) süsteemi rolli ja eesmärgi täpne määratlus, (2) iga tagasisidekategooria kohta vähehetk-näited, (3) väljundskeemi nõue (JSON), ja (4) mõtteahel-element, mille käigus mudel peab iga tuvastatud probleemi puhul põhjendama, miks see probleem on. Prompti täielik tekst on esitatud lisas~II.
